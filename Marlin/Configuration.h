...
#define STRING_CONFIG_H_AUTHOR "(Langweiler, tuned config)" // Who made the changes.
 ...
 * Supports more than 2 Toolheas. See https://youtu.be/JolbsAKTKf4
 */
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, 0, -3.6 }
